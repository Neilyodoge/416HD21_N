Shader "Hidden/Shader/PP_Sharpen"
{
    Properties
    {
        ...
        _SharpIntensity("LerpBase",range(0,1)) = 0.2
    }
    ...
    float4 CustomPostProcess(Varyings input) : SV_Target
    {
        ...
        float3 SharpenFilterResult = sharpenFilter(ClampAndScaleUVForBilinearPostProcessTexture(input.texcoord.xy));

        // Apply greyscale effect
        color = lerp(sourceColor, SharpenFilterResult, _SharpIntensity);
